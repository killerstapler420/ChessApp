...
{
    class V2ThreadingBot : IBot
    {
        private int _depth;

        public V2ThreadingBot(int depth)
        {
            _depth = depth;
        }
        public Move getBestMove(ChessBoard chessBoard)
        {
            ...
            int totalMoves = chessBoard.GetLegalMoves().Count;
            ...
            while (threadsfinished != totalMoves)
            {
            }
